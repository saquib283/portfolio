...
"[project]/src/models/Analytics.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs, [project]/node_modules/mongoose)");
;
const AnalyticsSchema = new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["Schema"]({
    path: {
        type: String,
        required: true,
        unique: true
...
const Analytics = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].models.Analytics || __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].model('Analytics', AnalyticsSchema);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Analytics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/Analytics.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        if (!path) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Path required'
        }, {
            status: 400
        });
        ...
        let record = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Analytics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
            path
        }, {
            $inc: {
                views: 1
        ...
        if (record) {
            const dayStatIndex = record.dailyStats.findIndex((s)=>s.date === today);
            if (dayStatIndex > -1) {
                record.dailyStats[dayStatIndex].count += 1;
            } else {
                record.dailyStats.push({
                    date: today,
                    count: 1
                });
...
async function GET(req) {
    try {
        ...
        const allStats = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Analytics$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].find({});
        const totalViews = allStats.reduce((acc, curr)=>acc + curr.views, 0);
        // Group by day for the chart
        const dailyMap = {};
        allStats.forEach((page)=>{
            page.dailyStats.forEach((day)=>{
                dailyMap[day.date] = (dailyMap[day.date] || 0) + day.count;
            });
        });
        const chartData = Object.entries(dailyMap).sort((a, b)=>a[0].localeCompare(b[0])).map(([date, count])=>({
                date,
                views: count
            })).slice(-7); // Last 7 days
        const topPages = allStats.sort((a, b)=>b.views - a.views).slice(0, 5).map((p)=>({
                path: p.path,
                views: p.views
            }));
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__ec308e9d._.js.map